package com.maukaim.blob.plugins.annotation.processor.utils;
...
public class FileSystemHelper {
    public static final String MODULE_INDEX_RESOURCE = "META-INF/services/com.maukaim.blob.plugins.api.plugin.Module";
